...
function TemplateSidebar({
  ...
  const handleUpload = async (e) => {
    ...
    if (
      !templateName ||
      !htmlFile ||
      (!thumbnailFile && !autoGenerateThumbnail)
    ) {
    ...
    try {
      ...
      formData.append(
        ...
        autoGenerateThumbnail.toString()
      );
        ...
        <div className="p-4 border-b border-beige-200 flex justify-between items-center">
          ...
          >
            <svg
              ...
              className="h-5 w-5 text-beige-800"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
                  ...
                  filteredTemplates.map((template) => (
                    ...
                    >
                      <div className="relative">
                        <img
                          src={templateApi.getTemplateThumbnailUrl(
                            template._id
                          )}
                          alt={template.name}
                          ...
                          onError={(e) => {
                            ...
                            console.error(
                              `Failed to load thumbnail for template: ${template.name}`
                            );
                          }}
                        />
                      </div>
                      <div className="p-3">
                        <h3 className="font-medium text-beige-900 mb-1">
                          {template.name}
                        </h3>
              ...
              <form onSubmit={handleUpload} className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      setAutoGenerateThumbnail(!autoGenerateThumbnail)
                    }
                    className="w-4 h-4 text-beige-700 border-beige-300 rounded focus:ring-beige-500"
                  />
                  <label
                    htmlFor="auto-generate"
                    className="ml-2 text-sm text-beige-800"
                  >
                ...
                >
                  <label className="block mb-1 font-medium text-beige-800">
                    Thumbnail Image{" "}
                    {autoGenerateThumbnail && "(Auto-generated)"}
                  </label>
                  <input
                    type="file"
                    accept="image/*"
